...
@section('content')
    ...
    <div class="ms-content-wrapper">
        <div class="row">
            ...
            @php
                ...
                if (count($details) > 0) {
                    if (!isset($case_files)) {
                        $caseFiles = DB::table('case_files')
                            ->where('case_id', '=', $details[0]->id)
                            ->get();
                        ...
                        <div class="ms-panel-body">
                            ...
                            <ul class="my_info">
                                ...
                                @foreach ($case_files as $key => $item)
                                    @if ($item == 'yes')
                                        <li><a href="">{{ $loop->iteration }}) {{ $key }} <i
                                                    class="flaticon-tick-inside-circle ml-3"></i></a></li>
                                    @else
                        ...
                        <form action="{{ url('/file-uploads') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group mt-3">
                                <input type="text" class="form-control" name="title" value=""
                                    id="validationCustom03" placeholder="Please write a file caption" required>
                                    ...
                                    <div class="row">
                                        @foreach ($files as $item)
                                            ...
                                            @else
                                                <div class="col-md-3">
                                                    <img style=""
                                                        src="{{ asset('admin/assets/img/file-icon.png') }}">
                                                    <a href="{{ $item->file }}"
                                                        style="text-align: center;margin-left:12px"
                                                        download>{{ $item->title }}</a>
                                                </div>
                        ...
                        <div class="time-line">
                            <ul>
                                ...
                                @php
                                    $time_line = [];
                                    if (!isset($time_line)) {
                                        $lattestCase = DB::table('cases')
                                            ->where('user_id', '=', Auth::user()->id)
                                            ->orderBy('id', 'DESC')
                                            ->first();
                                        if (isset($lattestCase->id)) {
                                            $time_line[] = DB::table('timeline')
                                                ->where('case_id', '=', $lattestCase->id)
                                                ->get();
                                        }
                                    }
                                @endphp
                                ...
                                @foreach ($time_line as $item)
                                    <li>
                                        ...
                                        <span class="time-arrow"><img
                                                src="{{ asset('/admin/assets/img/custom/step-arrow.svg') }}"
                                                alt="" /></span>
                        ...
                        <div class="ms-chat-header px-3">
                            <div class="ms-chat-user-container media clearfix">
                                <div class="ms-chat-status ms-status-online ms-chat-img mr-3 align-self-center">
                                    <img src="assets/img/dashboard/rakhan-potik-1.jpg" class="ms-img-round"
                                        alt="people">
                                </div>
                            ...
                            <div class="tab-content">
                                    ...
                                    <ul class="ms-scrollable ms-quickbar-container">
                                        <li class="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                            <div
                                                ...
                                                <img src="assets/img/dashboard/rakhan-potik-2.jpg" class="ms-img-round"
                                                    alt="people">
                                            </div>
                                            <div class="media-body ms-chat-user-info mt-1">
                                        ...
                                        <li class="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                            <div
                                                ...
                                                <img src="assets/img/dashboard/rakhan-potik-3.jpg" class="ms-img-round"
                                                    alt="people">
                                            </div>
                                            <div class="media-body ms-chat-user-info mt-1">
                                        ...
                                        <li class="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                            <div
                                                ...
                                                <img src="{{ asset('/admin/assets/img/dashboard/rakhan-potik-4.jpg') }}"
                                        ...
                                        <li class="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                            <div class="ms-chat-status ms-status-busy ms-chat-img mr-3 align-self-center">
                                                <img src="{{ asset('/admin/assets/img/dashboard/rakhan-potik-5.jpg') }}"
                                                    class="ms-img-round" alt="people">
                                            </div>
                                            <div class="media-body ms-chat-user-info mt-1">
                                        ...
                                        <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                            ...
                                            <div class="media-body ms-chat-user-info mt-1">
                                                ...
                                                <ul class="ms-group-members clearfix mt-3 mb-0">
                                                    <li> <img src="assets/img/dashboard/rakhan-potik-1.jpg"
                                                            alt="member"> </li>
                                                    <li> <img src="assets/img/dashboard/rakhan-potik-2.jpg"
                                                            alt="member"> </li>
                                                    <li> <img src="assets/img/dashboard/rakhan-potik-3.jpg"
                                                            alt="member"> </li>
                                        ...
                                        <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                            ...
                                            <div class="media-body ms-chat-user-info mt-1">
                                                ...
                                                <ul class="ms-group-members clearfix mt-3 mb-0">
                                                    <li> <img src="assets/img/dashboard/rakhan-potik-3.jpg"
                                                            alt="member"> </li>
                                                    <li> <img src="assets/img/dashboard/rakhan-potik-4.jpg"
                                                            alt="member"> </li>
                                                </ul>
                                            </div>
                                        </li>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="contacts">
                                    <ul class="ms-scrollable ms-quickbar-container">
                                        <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                            <div class="ms-chat-img mr-3 align-self-center">
                                                <img src="assets/img/dashboard/rakhan-potik-5.jpg" class="ms-img-round"
                                                    alt="people">
                                            </div>
                                            <div class="media-body ms-chat-user-info mt-1">
                                                <h6>John Doe</h6> <a href="#" class="ms-chat-time"> <i
                                        ...
                                        <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                            <div class="ms-chat-img mr-3 align-self-center">
                                                <img src="assets/img/dashboard/rakhan-potik-7.jpg" class="ms-img-round"
                                                    alt="people">
                                            </div>
                                            <div class="media-body ms-chat-user-info mt-1">
                                                <h6>Raymart Sandiago</h6> <a href="#" class="ms-chat-time"> <i
                                        ...
                                        <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                            <div class="ms-chat-img mr-3 align-self-center">
                                                <img src="assets/img/dashboard/rakhan-potik-8.jpg" class="ms-img-round"
                                                    alt="people">
                                            </div>
                                            <div class="media-body ms-chat-user-info mt-1">
                        ...
                        <div class="ms-card ms-qa-card ms-deletable">
                            ...
                            <div class="ms-card-body">
                                ...
                                <ul class="ms-note-members clearfix mb-0">
                                    <li class="ms-deletable"> <img src="assets/img/dashboard/rakhan-potik-2.jpg"
                                            alt="member"> </li>
                                    <li class="ms-deletable"> <img src="assets/img/dashboard/rakhan-potik-3.jpg"
                                            alt="member"> </li>
                                </ul>
                            </div>
                            <div class="ms-card-footer clearfix">
                                        ...
                                        <li class="ms-scrollable ms-dropdown-list ms-members-list">
                                            <a class="media p-2" href="#">
                                                <div class="mr-2 align-self-center">
                                                    <img src="assets/img/dashboard/rakhan-potik-4.jpg"
                                                        class="ms-img-round" alt="people">
                                                </div>
                                                <div class="media-body">
                                                    <span>John Doe</span>
                                            ...
                                            <a class="media p-2" href="#">
                                                <div class="mr-2 align-self-center">
                                                    <img src="assets/img/dashboard/rakhan-potik-5.jpg"
                                                        class="ms-img-round" alt="people">
                                                </div>
                                                <div class="media-body">
                                            ...
                                            <a class="media p-2" href="#">
                                                <div class="mr-2 align-self-center">
                                                    <img src="assets/img/dashboard/rakhan-potik-7.jpg"
                                                        class="ms-img-round" alt="people">
                                                </div>
                                                <div class="media-body">
                                ...
                                <div class="dropdown float-left">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="ms-scrollable ms-dropdown-list ms-members-list">
                                            <a class="media p-2" href="#">
                                                <div class="mr-2 align-self-center">
                                                    <img src="assets/img/dashboard/rakhan-potik-1.jpg"
                                                        class="ms-img-round" alt="people">
                                                </div>
                                                <div class="media-body">
                                                    <span>John Doe</span>
                                            ...
                                            <a class="media p-2" href="#">
                                                <div class="mr-2 align-self-center">
                                                    <img src="assets/img/dashboard/rakhan-potik-8.jpg"
                                                        class="ms-img-round" alt="people">
                                                </div>
                                                <div class="media-body">
                                                    <span>Heather Brown</span>
    ...
    <script>
        async function editCase(id) {
            let response = await axios.get(`/api/edit-case-details/${id}`);
            case_description
            document.getElementById('case_title').setAttribute('value', response.data.case_title);
            document.getElementById('case_id').setAttribute('value', response.data.id);
            document.getElementById('case_description').value = response.data.description;
        }

        async function updateCase() {
            let id = document.getElementById('case_id').value;
            let case_title = document.getElementById('case_title').value;
            let case_description = document.getElementById('case_description').value;
            const formDate = {
                case_title: case_title,
                case_description: case_description
            }
            let update = await axios.post(`/api/update-case-details/${id}`, formDate)
